...
class Measure(Protocol):
    ...
    def start(self) -> None:
        ...
        if (
            self.FockBS._receivers[0].photon_counter2 == 1
            or self.FockBS._receivers[1].photon_counter2 == 1
        ):
        ...
        if (
            self.FockBS._receivers[0].photon_counter == 1
            or self.FockBS._receivers[1].photon_counter == 1
        ):
