...
for mean_num in mean_num_list:
    ...
    for mode_num in mode_num_list:
        ...
        delay_fiber = (
            delay_fiber_anl  # time for photon to travel from SPDC source to BSM device
        )
        delay_classical = (
            DELAY_CLASSICAL * 1e12
        )  # delay for classical communication between BSM node and memory nodes
