...
class TeleportProtocol(Protocol):
    ...
    def __init__(
        self, owner: DQCNode, alice: bool = False, data_memory_index: int = None, remote_node_name: str = None
    ):
    ...
    def bob_acknowledge_complete(self, reservation: Reservation):
        ...
        """
        msg = TeleportMessage(
            TeleportMsgType.ACK, bob_comm_memory_name=self.bob_comm_memory_name, reservation=reservation
        )
        self.owner.send_message(self.remote_node_name, msg)
