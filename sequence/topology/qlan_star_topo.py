from .star_topo import StarTopo
...
class QlanStarTopo(StarTopo):
    """Class for generating qlan topology with a single orchestrator and multiple clients

    Class QlanStarTopo is the child of class StarTopo. Orchestrator nodes, Client nodes, quantum  channels,
