...
def getInputField(
    value_in: str, label: str, input_id: str, out_type: str, style_in=None, place=None
):
    return dbc.Row(
        [
            ...
            dbc.Col(
                dbc.Input(
                    id=input_id, value=value_in, className=out_type, placeholder=place
                ),
                width=8,
            ),
        ],
...
def getDropdownField(
    ...
    return dbc.Row(
        [
            ...
            dbc.Col(
                dcc.Dropdown(
                    id=input_id, options=all_vals, value=value_in, className=out_type
                ),
                width=8,
            ),
        ],
...
def getSelectedNodeMenu(values, templates):
    ...
    out.append(
        getDropdownField(
            values["type"], OPTIONS_NODE, "Node Type:", "selected_node_type", "type"
        )
    )
    out.append(
        getDropdownField(
...
def getSelectedEdgeMenu(values, nodes, link_types):
    return dbc.Form(
        [
            ...
            getInputField(
                values["distance"], "Distance (m):", "selected_distance", "distance"
            ),
        ]
    )
...
quantum_memory_template = [
    ...
    dbc.Row(
        [
            dbc.Col(
                dbc.Input(
                    id="coh_time_in", className="coherence_time", placeholder="1.3e12"
                ),
                width=10,
            ),
    ...
    dbc.Row(
        [
            dbc.Col(
                dbc.Input(id="mem_freq_in", className="frequency", placeholder="2000"),
                width=10,
            ),
...
qkd_template = [
    ...
    dcc.Dropdown(
        id="stack_size_in", className="stack_size", value="", options=[1, 2, 3, 4, 5]
    ),
]
...
make_new_template = html.Div(
    dbc.Form(
        [
            ...
            getDropdownField(
                "QuantumRouter", OPTIONS_TEMPLATE, "Type:", "template_type_menu", ""
            ),
    ...
    [
        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    dbc.Input(id="sim_time_in", placeholder="Enter simulation time"),
                    width=8,
                ),
                dbc.Col(
                    getTimeUnits("sim"),
        ...
        html.A(
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        dbc.NavbarBrand(
                            "SeQUeNCe", className="ml-2", style={"font-size": "50px"}
                        )
                    ),
                ],
                align="center",
