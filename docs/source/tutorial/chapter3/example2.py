...
class SimpleManager:
    ...
    def create_protocol(self):
        ...
        self.owner.protocols = [
            BBPSSWProtocol.create(
                self.owner, "purification_protocol", kept_memo, meas_memo
            )
        ]
...
if __name__ == "__main__":
    ...
    for i in range(10):
        entangle_memory(
            tl, kept_memo_1, kept_memo_2, 0.9
        )  # this version of purification always success, need to fix
