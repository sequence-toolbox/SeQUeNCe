...
def test_find_adjacent_nodes():
    ...
    Orchestrator = QlanOrchestratorNode("node1",
                                        tl, 
                                        num_local_memories=2, remote_memories=[remote_memo_1, remote_memo_2, remote_memo_3])
...
def test_update_bases():
    ...
    Orchestrator = QlanOrchestratorNode("node1",
                                        tl, 
                                        num_local_memories=3, remote_memories=[remote_memo_1, remote_memo_2, remote_memo_3, remote_memo_4])
...
def test_set_app():
    ...
    Orchestrator = QlanOrchestratorNode("node1",
                                        tl, 
                                        num_local_memories=0, remote_memories=[remote_memo_1])
...
def test_reset_linear_state():
    ...
    Orchestrator = QlanOrchestratorNode("node1",
                                        tl, 
                                        num_local_memories=1, remote_memories=[remote_memo_1, remote_memo_2])
...
def test_generate_chain_state():
    ...
    Orchestrator.resource_manager.generate_chain_state(tl=tl,
                                                    local_memories=Orchestrator.local_memories, remote_memories=Orchestrator.remote_memories)
