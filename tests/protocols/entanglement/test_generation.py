...
def test_generation_run():
    ...
    # add protocols
    eg_e0 = EntanglementGenerationA(e0, "eg_e0", middle="m0", other="e1", other_protocol="eg_e1", memory_index=0, another_index=0)
    eg_e0.primary = True
    eg_e0.debug = True
    eg_e1 = EntanglementGenerationA(e1, "eg_e1", middle="m0", other="e0", other_protocol="eg_e0", memory_index=0, another_index=0)
