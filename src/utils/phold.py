...
class PholdNode():
    ...
    def __init__(self, name:'str', timeline:'ParallelTimeline', init_work:int, lookahead:int, neighbors:'List[str]'):
        self.name = name
    ...
    def generate_event(self) -> Event:
        ...
        event = Event(self.timeline.now() + self.lookahead + int(exponential(self.lookahead)), process)
        return event
